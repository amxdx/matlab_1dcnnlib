function [cnni, cnno, cnnp] = interim_wt021(init)
%% Net parameters
...
cnno.calculated_op = zeros(init.trainsize,1); %output calculated at the end
...
cnni.fcL2W = cnnp.fullconnwt2*rand(cnnp.fcL1_interim,1);

cnni.fcL1W = cnni.fcL1W*cnnp.fcL1_interim/length(cnni.fcL1W);
cnni.fcL2W = cnni.fcL2W/cnnp.fcL1_interim;
cnno.error = zeros(init.trainsize,1);
