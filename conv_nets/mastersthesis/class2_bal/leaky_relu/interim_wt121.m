...
param.fc1rate = 0.01; param.fc2rate = 0.01; %learning rates
param.fconv1rate = .01; param.fconv2rate = 0.01; %learning rates 

param.fcL1_interim = 204; %interim number of units in fully connected layer
